...
public class ModelTableVisualizzaOperazioni extends AbstractTableModel  {
	
	
	private ArrayList<Operazione> dati;
		
	private String[] titoli= {"Id_Operazione", "Data", "Importo", "Descrizione","Data_Accettazione"};
		
		
	public ModelTableVisualizzaOperazioni(ArrayList<Operazione> dati) {
		super();
		this.dati = dati;
	}
	...
	public Object getValueAt(int rowIndex, int columnIndex) {
		...
		else if(columnIndex==4) return operazione.getDataAccettazione();
		return null;
	}
